                      ...
                      <td className='px-4 py-4 text-sm whitespace-nowrap'>
                        <div className='flex items-center gap-x-2'>
                          <p
                            ...
                            text-xs ${job.category === 'Web Development' && 'text-blue-500 bg-blue-100/60'} ${job.category === 'Digital Marketing' && 'text-pink-500 bg-pink-100/60'} ${job.category === 'Graphic Design' && 'text-emerald-500 bg-emerald-100/60'}
                            `}
                            >
                              {job.category}
                          </p>
